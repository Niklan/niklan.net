...
/**
 * @implements \Drupal\external_content\Contract\Pipeline\Pipeline<\Drupal\external_content\Contract\Pipeline\PipelineStage, \Drupal\app_blog\ExternalContent\Domain\ArticleTranslationProcessContext>
 */
#[Autoconfigure(
  calls: [
...
final readonly class ArticleProcessPipeline implements Pipeline {
  ...
  /**
   * @var \Drupal\external_content\Pipeline\SequentialPipeline<\Drupal\external_content\Contract\Pipeline\PipelineStage<\Drupal\app_blog\ExternalContent\Domain\ArticleTranslationProcessContext>, \Drupal\app_blog\ExternalContent\Domain\ArticleTranslationProcessContext>
   */
  ...
  /**
   * @param \Drupal\app_blog\ExternalContent\Domain\ArticleTranslationProcessContext $context
   */
