...
namespace Drupal\app_blog\ExternalContent\Parser;

use Drupal\app_blog\ExternalContent\Domain\Article;
use Drupal\app_blog\ExternalContent\Domain\ArticleTranslation;
use Drupal\app_blog\ExternalContent\Exception\ArticleParseException;
...
final readonly class ArticleXmlParser {
  ...
  /**
   * @throws \Drupal\app_blog\ExternalContent\Exception\ArticleParseException
   */
