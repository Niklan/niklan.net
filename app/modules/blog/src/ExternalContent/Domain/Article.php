...
use Drupal\app_blog\ExternalContent\Exception\PrimaryTranslationNotFoundException;

/**
 * @implements \IteratorAggregate<int, \Drupal\app_blog\ExternalContent\Domain\ArticleTranslation>
 */
final class Article implements \IteratorAggregate, \Countable {

  /**
   * @var list<\Drupal\app_blog\ExternalContent\Domain\ArticleTranslation>
   */
  ...
  /**
   * @return \ArrayIterator<int, \Drupal\app_blog\ExternalContent\Domain\ArticleTranslation>
   */
  ...
  /**
   * @return array{}|list<\Drupal\app_blog\ExternalContent\Domain\ArticleTranslation>
   */
