...
/**
 * @implements \Drupal\external_content\Contract\Builder\Array\Builder<\Drupal\app_blog\ExternalContent\Nodes\CalloutBody\CalloutBody>
 */
final readonly class ArrayBuilder implements Builder {

  public function supports(Node $node): bool {
    return $node instanceof CalloutBody;
  }
