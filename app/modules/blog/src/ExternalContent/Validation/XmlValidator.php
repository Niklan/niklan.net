...
namespace Drupal\app_blog\ExternalContent\Validation;

use Drupal\app_blog\ExternalContent\Exception\XmlLoadException;
use Drupal\app_blog\ExternalContent\Exception\XmlValidationException;
...
final readonly class XmlValidator {
  ...
  /**
   * @throws \Drupal\app_blog\ExternalContent\Exception\XmlLoadException
   * @throws \Drupal\app_blog\ExternalContent\Exception\XmlValidationException
   */
