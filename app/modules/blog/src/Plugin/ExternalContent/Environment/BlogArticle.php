...
namespace Drupal\app_blog\Plugin\ExternalContent\Environment;
...
use Drupal\app_blog\ExternalContent\Extension\ArrayBuilderExtension as CustomArrayBuilderExtension;
use Drupal\app_blog\ExternalContent\Extension\ArrayParserExtension as CustomArrayParserExtension;
use Drupal\app_blog\ExternalContent\Extension\HtmlParserExtension as CustomHtmlParserExtension;
use Drupal\app_blog\ExternalContent\Extension\RenderArrayBuilderExtension as CustomRenderArrayExtension;
...
final class BlogArticle extends PluginBase implements EnvironmentPlugin, ContainerFactoryPluginInterface {
  ...
  public const string ID = 'app_blog_article';
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition): self {
    $converter = $container->get(MarkdownConverter::class);
    \assert($converter instanceof MarkdownConverter);
    return new self(
