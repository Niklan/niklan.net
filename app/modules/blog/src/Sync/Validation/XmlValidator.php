...
namespace Drupal\app_blog\Sync\Validation;
...
final readonly class XmlValidator {
  ...
  /**
   * @throws \Drupal\app_blog\Sync\Exception\XmlLoadException
   * @throws \Drupal\app_blog\Sync\Exception\XmlValidationException
   */
