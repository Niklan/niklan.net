...
final class Deploy0002 implements ContainerInjectionInterface {
  ...
  protected function getExternalIdMapping(): array {
    ...
    return [
      ...
      '3' => 'netbeans-drupal-coding-standards',
      '4' => 'easy-start-with-drupal-on-windows',
      '5' => 'tvs-are-better-than-ie10',
      '6' => 'd7fb-drupal',
      '7' => 'd7fb-admin',
      '8' => 'd7fb-translate',
      '9' => 'd7fb-content',
      '11' => 'd7fb-configure',
      '12' => 'd7fb-content-types',
      '13' => 'd7fb-fields',
      '14' => 'd7fb-display',
      '15' => 'd7fb-taxonomy',
      '16' => 'd7fb-blocks',
      '17' => 'd7fb-modules',
      '18' => 'd7fb-views',
      '19' => 'd7fb-path-aliases',
      '20' => 'd7fb-contact',
      '21' => 'd7fb-update',
      '22' => 'install-drush-on-ubuntu-drupalhosting',
      '23' => 'drupal-code-style-check-ubuntu',
      '24' => 'd7-catalog-with-views-panels',
      '25' => 'd7-fix-encrypted-connection-error',
      '26' => 'fix-adsense-not-loading',
      '27' => 'integrate-color-module-into-theme',
      '28' => 'd7-create-customer-support-system',
      '29' => 'views-grid-with-div',
      '30' => 'd7-print-menu-programmatically',
      '31' => 'ubuntu-13-fix-bash-scripts',
      '32' => 'd7-create-feature',
      '33' => 'block-content-access-with-rules',
      '34' => 'simple-way-to-translate-drupal',
      '35' => 'create-like-button-with-rate-module',
      '36' => 'smooth-transition-on-page-change',
      '37' => 'advanced-contact-page',
      '38' => 'd7-boost',
      '39' => 'd7-attach-js',
      '40' => 'prepare-project-for-drupal.org',
      '41' => 'create-callback-form-with-webform',
      '42' => 'mappy-easy-map-embedding',
      '43' => 'mappy-7.x-1.2',
      '44' => 'a-look-at-the-drupal-8-alpha',
      '46' => 'drupalstorm',
      '47' => 'hierarchical-path-aliases',
      '48' => 'crop-image-without-cut',
      '49' => 'mappy-7.x-1.3',
      '50' => 'd7-custom-theme-settings',
      '51' => 'how-to-fix-sa-core-2013-003',
      '52' => 'add-fonts-into-google-docs',
      '53' => 'follow-functionality-with-flag',
      '54' => 'd7-install-and-configure-ckeditor',
      '55' => 'indexisto-drupal-module',
      '56' => '3-years-width-drupal',
      '57' => 'drupalife-store-preview',
      '58' => 'd7-create-distribution',
      '59' => 'blog-is-1-year',
      ...
      '66' => 'd8-hello-world',
      '67' => 'd8-print-menu-programmatically',
