...
final class MobileHeaderBarBlockTest extends BlockTestBase {
  ...
  public function testBlock(): void {
    ...
    $block_instance = $this->blockManager->createInstance('niklan_mobile_header_bar');
    ...
    $this->assertStringContainsString(Url::fromRoute('<front>')->setAbsolute()->toString(), $block_html);
    $this->assertStringContainsString('js-navigation-mobile-toggle', $block_html);
  }
